...
# Define Bayesian optimization functions for each model
...
def optimize_with_bayes(X, y):
    ...
    results.append({"Model": "RandomForest", "Best Parameters": rf_opt.max["params"], "Best ROC AUC": rf_opt.max["target"]})
    ...
    results.append({"Model": "CatBoost", "Best Parameters": cb_opt.max["params"], "Best ROC AUC": cb_opt.max["target"]})
    ...
    results.append({"Model": "LGBM", "Best Parameters": lgbm_opt.max["params"], "Best ROC AUC": lgbm_opt.max["target"]})
    ...
    results.append({"Model": "XGB", "Best Parameters": xgb_opt.max["params"], "Best ROC AUC": xgb_opt.max["target"]})
